...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -737.5780777722186; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 659.9007796760645; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1448.966142744284; // x position of the perpendicular encoder (in tick units)
    }
